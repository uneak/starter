...
class ConstraintApiController extends FOSRestController
{
     ...
     */
    // [GET] /users
    public function getConstraintsAction(ParamFetcher $paramFetcher)
    {
        ...
        $constraintsRepository = $em->getRepository('ConstraintBundle:Constraint');

        $constraints = $constraintsRepository->findAll();
     ...
     *    deprecated=false,
     *   output = "ConstraintBundle\Entity\Constraint",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     */
    public function getConstraintAction($id)
    {
     ...
     */
    public function postConstraintAction(Request $request)
    {
        $handler = $this->container->get('uneak.admin.user.crud.handler');
