...
use GroupFieldBundle\Entity\GroupField;
...
class GroupFieldAPIHandler extends EntityAPIHandler {
    ...
    public function get($id) {
        $entity = $this->em->getRepository('GroupFieldBundle:GroupField')->findOneBy(array('id' => $id));
        if (!$entity) {
            throw new NotFoundException("GroupField $id not found", $id);
        }
        return $entity;
    }
