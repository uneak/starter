...
namespace GroupFieldBundle\Controller;
...
class GroupFieldApiController extends FOSRestController
{
     ...
     */
    // [GET] /users
    public function getGroupFieldsAction(ParamFetcher $paramFetcher)
    {
        ...
        $fieldsRepository = $em->getRepository('GroupFieldBundle:GroupField');
     ...
     *    deprecated=false,
     *   output = "GroupFieldBundle\Entity\GroupField",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     */
    public function getGroupFieldAction($id)
    {
     ...
     */
    public function postGroupFieldAction(Request $request)
    {
        $handler = $this->container->get('uneak.admin.user.crud.handler');
