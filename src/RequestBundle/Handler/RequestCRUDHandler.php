<?php
	...
	class RequestCRUDHandler extends CRUDHandler {
        ...
        public function getForm(FlattenRoute $route, $method = Request::METHOD_POST) {
            ...
            if ($route->hasParameter('requests')) {
                $requests = $route->getParameter('requests')->getParameterSubject();
            } else {
                $requests = null;
            }

            $entity = ($requests) ? $requests : $this->createEntity();
