...
class RequestApiController extends FOSRestController
{
     ...
     */
    // [GET] /users
    public function getRequestsAction(ParamFetcher $paramFetcher)
    {
        ...
        $requestsRepository = $em->getRepository('RequestBundle:Request');
     ...
     *    deprecated=false,
     *   output = "RequestBundle\Entity\Request",
     *   statusCodes = {
     *     200 = "Returned when successful",
