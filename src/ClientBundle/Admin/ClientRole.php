<?php
	...
	use ClientBundle\Form\ClientRoleDeleteType;
	use ClientBundle\Form\ClientRoleType;
    ...
    class ClientRole extends NestedCRUDRoute {

		protected $entity = 'ClientBundle\Entity\ClientRole';

		public function initialize() {
			parent::initialize();

            $this->setFormType(new ClientRoleType());
		...
		protected function buildCRUD() {
			...
			$deleteRoute
                ...
                ->setMetaData('_description', '{{ entity }}')
				->setFormType(new ClientRoleDeleteType());
