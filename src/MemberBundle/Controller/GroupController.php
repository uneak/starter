<?php
	...
	use MemberBundle\FOSUserEvents;
	...
	class GroupController extends Controller {
		...
		public function listAction() {
			...
			return $this->render('MemberBundle:Member/Group:list.html.twig', array(
				'groups' => $groups
			));
		}
		...
		public function showAction($groupName) {
			...
			return $this->render('MemberBundle:Member/Group:show.html.twig', array(
				'group' => $group
			));
		}
		...
		public function editAction(Request $request, $groupName) {
			...
			if ($form->isValid()) {
				...
				if (null === $response = $event->getResponse()) {
					$url = $this->generateUrl('member_group_show', array('groupName' => $group->getName()));
			...
			return $this->render('MemberBundle:Member/Group:edit.html.twig', array(
		...
		public function newAction(Request $request) {
			...
			return $this->render('MemberBundle:Member/Group:new.html.twig', array(
				'form' => $form->createview(),
			));
		}
		...
		public function deleteAction(Request $request, $groupName) {
			...
			$response = new RedirectResponse($this->generateUrl('member_group_list'));
