...
class CampaignApiController extends FOSRestController
{
    ...
    public function getCampaignsAction(ParamFetcher $paramFetcher)
    {
        ...
        $campaignsRepository = $em->getRepository('CampaignBundle:Campaign');
     ...
     *    deprecated=false,
     *   output = "CampaignBundle\Entity\Campaign",
     *   statusCodes = {
     *     200 = "Returned when successful",
