<?php
	...
	class EntityToolbarMenuTemplate extends MenuTemplate {
...
//				))
		...
		public function buildOptions(TemplatesManager $templatesManager, $block, array &$options) {
            ...
            $options['parameters'] = array_merge($parameters, array(
                'template' => $templatesManager->getTemplate('knp_entity_toolbar_menu_template'),
        ...
        public function getRenderTemplate() {
            return 'block_entity_toolbar_menu_template';
        }
