<?php
	...
	class BsDateTimeConfigType extends AssetsFormType {
		...
		public function buildForm(FormBuilderInterface $builder, array $options) {
			...
			$builder
				...
				->add('stepping', 'number', array(
					'empty_data'  => null,
					'attr' => array(
						'help_text' => "Number of minutes the up/down arrow's will move the minutes value in the time picker",
					)
				))
...
//				))
		...
		public function getName() {
			return 'config_uneak_bs_datetime_picker';
		}
	}
