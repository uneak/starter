...
interface SignatureInterface {
	...
	public function buildRequestOptions(CredentialsConfigurationInterface $credentials, ServerOAuth1ConfigurationInterface $server, AuthenticationConfigurationInterface $authenticationConfiguration, array &$options);
