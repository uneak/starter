<?php
	...
	namespace ProspectGroupFieldBundle\Admin;

	use ProspectGroupFieldBundle\Form\ProspectGroupFieldDeleteType;
	use ProspectGroupFieldBundle\Form\ProspectGroupFieldType;
    ...
    class ProspectGroupField extends NestedCRUDRoute {
...
//            $subjectRoute->addChild($constraintRoute);
			...
			$deleteRoute
                ...
                ->setMetaData('_description', '{{ entity }}')
				->setFormType(new ProspectGroupFieldDeleteType());
