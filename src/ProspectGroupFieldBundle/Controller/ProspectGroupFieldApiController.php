...
class ProspectGroupFieldApiController extends FOSRestController
{
    ...
    public function getGroupFieldsAction(ParamFetcher $paramFetcher)
    {
        ...
        $fieldsRepository = $em->getRepository('UneakFieldBundle:Field');
     ...
     *    deprecated=false,
     *   output = "Uneak\FieldBundle\Entity\Field",
     *   statusCodes = {
     *     200 = "Returned when successful",
