...
use UserBundle\Templating\Helper\OAuthHelper;
...
class OAuthExtension extends \Twig_Extension
{
    ...
    {
        return array(
            'user_oauth_authorization_url' => new \Twig_Function_Method($this, 'getAuthorizationUrl'),
            'user_oauth_login_url'         => new \Twig_Function_Method($this, 'getLoginUrl'),
            'user_oauth_resource_owners'   => new \Twig_Function_Method($this, 'getResourceOwners')
        );
    }
