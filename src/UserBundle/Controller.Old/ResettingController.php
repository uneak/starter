...
class ResettingController extends LayoutFormInterfaceController
{
    ...
    public function requestAction()
    {
        ...
        $content = new Twig('fos_resetting_request');
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        if (null === $user) {
            ...
            $content = new Twig('fos_resetting_request', array(
        ...
        if ($user->isPasswordRequestNonExpired($this->container->getParameter('fos_user.resetting.token_ttl'))) {
            ...
            $content = new Twig('fos_resetting_password_already_requested');
            $this->layout->setContent($content);
            return null;
        }
    ...
    public function checkEmailAction(Request $request)
    {
        ...
        $this->layout->setIcon("key");
        $this->layout->setTitle("Réinitialisation du mot de passe");
        $content = new Twig('fos_resetting_check_email', array(
            'email' => $email,
        ));
        $this->layout->setContent($content);
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        $this->layout->setIcon("key");
        $this->layout->setTitle("Réinitialisation du mot de passe");
        $content = new Twig('fos_resetting_reset', array(
            'token' => $token,
