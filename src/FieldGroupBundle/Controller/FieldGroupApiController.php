...
class FieldGroupApiController extends FOSRestController
{
     ...
     */
    // [GET] /users
    public function getFieldGroupsAction(ParamFetcher $paramFetcher)
    {
     ...
     */
    public function getFieldGroupAction($id)
    {
     ...
     */
    public function postFieldGroupAction(Request $request)
    {
        $handler = $this->container->get('uneak.admin.user.crud.handler');
