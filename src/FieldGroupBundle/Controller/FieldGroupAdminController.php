<?php
    ...
    class FieldGroupAdminController extends LayoutEntityController {
        ...
        public function prospectsImportcsvAction(FlattenRoute $route, Request $request) {
            return $this->forward('ProspectBundle:ProspectAdmin:importCsv', array('route' => $route->getParameter('groups')->getChild('prospects/import/csv'), 'request' => $request));
        }
        public function prospectsImportCsvProceedAction(FlattenRoute $route, Request $request) {
            return $this->forward('ProspectBundle:ProspectAdmin:importCsvProceed', array('route' => $route->getParameter('groups')->getChild('prospects/import/csv/proceed'), 'request' => $request));
        }
